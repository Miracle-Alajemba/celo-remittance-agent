...
import type { BrokerProxy, BrokerProxyInterface } from "../BrokerProxy";
export declare class BrokerProxy__factory {
    ...
    static createInterface(): BrokerProxyInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): BrokerProxy;
}
