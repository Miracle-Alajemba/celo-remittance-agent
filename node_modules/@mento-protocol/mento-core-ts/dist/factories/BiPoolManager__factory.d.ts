...
import type { BiPoolManager, BiPoolManagerInterface } from "../BiPoolManager";
export declare class BiPoolManager__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "CONSTANT_PRODUCT";
        readonly inputs: readonly [];
        ...
        readonly outputs: readonly [{
            ...
            readonly internalType: "contract IBreakerBox";
        }];
        readonly stateMutability: "view";
    }, {
        readonly type: "function";
        ...
        readonly inputs: readonly [{
            ...
            readonly type: "address";
            readonly internalType: "contract IReserve";
        }, {
        ...
        readonly type: "function";
        readonly name: "setPricingModules";
        readonly inputs: readonly [{
        ...
        readonly type: "event";
        readonly name: "PricingModulesUpdated";
        readonly inputs: readonly [{
            readonly name: "newIdentifiers";
            readonly type: "bytes32[]";
            readonly indexed: false;
            readonly internalType: "bytes32[]";
        }, {
    ...
    static createInterface(): BiPoolManagerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): BiPoolManager;
}
