...
export interface TimelockControllerInterface extends utils.Interface {
    functions: {
        ...
        "__MentoTimelockController_init(uint256,address[],address[],address,address)": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "__MentoTimelockController_init", values: [
    ...
    decodeFunctionResult(functionFragment: "__MentoTimelockController_init", data: BytesLike): Result;
...
export interface TimelockController extends BaseContract {
    ...
    functions: {
        ...
        __MentoTimelockController_init(minDelay: PromiseOrValue<BigNumberish>, proposers: PromiseOrValue<string>[], executors: PromiseOrValue<string>[], admin: PromiseOrValue<string>, canceller: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        PROPOSER_ROLE(overrides?: CallOverrides): Promise<string>;
        TIMELOCK_ADMIN_ROLE(overrides?: CallOverrides): Promise<string>;
        __MentoTimelockController_init(minDelay: PromiseOrValue<BigNumberish>, proposers: PromiseOrValue<string>[], executors: PromiseOrValue<string>[], admin: PromiseOrValue<string>, canceller: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
