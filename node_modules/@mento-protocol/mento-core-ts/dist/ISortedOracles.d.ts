...
export interface ISortedOraclesInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "addOracle" | "breakerBox" | "getOracles" | "getRates" | "getTimestamps" | "getTokenReportExpirySeconds" | "initialize" | "isOldestReportExpired" | "medianRate" | "medianTimestamp" | "numRates" | "numTimestamps" | "oracles" | "removeExpiredReports" | "removeOracle" | "report" | "setBreakerBox"): FunctionFragment;
    encodeFunctionData(functionFragment: "addOracle", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "breakerBox", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "getTokenReportExpirySeconds", values: [PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "oracles", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "setBreakerBox", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "getTokenReportExpirySeconds", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "setBreakerBox", data: BytesLike): Result;
    events: {};
}
export interface ISortedOracles extends BaseContract {
    ...
    functions: {
        ...
        getRates(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string[], BigNumber[], number[]]>;
        getTimestamps(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string[], BigNumber[], number[]]>;
        getTokenReportExpirySeconds(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>;
        initialize(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        oracles(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        ...
        setBreakerBox(arg0: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    addOracle(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        getTimestamps(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string[], BigNumber[], number[]]>;
        getTokenReportExpirySeconds(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        isOldestReportExpired(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean, string]>;
        medianRate(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        medianTimestamp(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        numRates(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setBreakerBox(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        addOracle(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: Overrides & {
        ...
        getRates(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        numRates(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        numTimestamps(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        oracles(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        removeExpiredReports(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        removeOracle(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, arg2: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    populateTransaction: {
        ...
        getRates(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getTimestamps(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getTokenReportExpirySeconds(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        ...
        oracles(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        removeExpiredReports(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        removeOracle(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, arg2: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
