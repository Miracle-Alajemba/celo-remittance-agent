...
export interface ConstantProductPricingModuleInterface extends utils.Interface {
    functions: {
...
export interface ConstantProductPricingModule extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConstantProductPricingModuleInterface;
