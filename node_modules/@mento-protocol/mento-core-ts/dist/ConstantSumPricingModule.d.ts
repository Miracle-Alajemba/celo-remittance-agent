...
export interface ConstantSumPricingModuleInterface extends utils.Interface {
    functions: {
...
export interface ConstantSumPricingModule extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConstantSumPricingModuleInterface;
