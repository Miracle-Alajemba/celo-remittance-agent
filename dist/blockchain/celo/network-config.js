...
exports.getCeloRpcUrl = getCeloRpcUrl;
exports.getCeloNetworkMode = getCeloNetworkMode;
exports.isMainnetMode = isMainnetMode;
exports.getCeloChainId = getCeloChainId;
exports.getCeloNetworkLabel = getCeloNetworkLabel;
exports.getDefaultRpcForMode = getDefaultRpcForMode;
exports.getStablecoinAddresses = getStablecoinAddresses;
...
function getCeloRpcUrl() {
    return ((0, config_1.getEnv)("CELO_RPC_URL") ||
        (0, config_1.getEnv)("ALFAJORES_RPC") ||
        SEPOLIA_RPC);
}
function getCeloNetworkMode() {
    const explicit = normalizeBoolean((0, config_1.getEnv)("MAINNET_MODE"));
    if (explicit === true)
        return "mainnet";
    if (explicit === false)
        return "sepolia";
...
function getCeloChainId() {
    return isMainnetMode() ? 42220 : 11142220;
}
function getCeloNetworkLabel(simulated = false) {
    if (isMainnetMode()) {
        return "Celo Mainnet";
    }
    return simulated ? "Celo Sepolia (simulated fallback)" : "Celo Sepolia";
}
function getDefaultRpcForMode(mode) {
...
function getStablecoinAddresses() {
