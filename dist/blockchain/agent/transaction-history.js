...
exports.resetTransactionHistory = resetTransactionHistory;
exports.recordTransaction = recordTransaction;
exports.getTransactionHistory = getTransactionHistory;
exports.getTransactionHistoryPersistent = getTransactionHistoryPersistent;
...
exports.getTransactionSummaryFromRecords = getTransactionSummaryFromRecords;
...
async function getTransactionHistoryPersistent(userId, limit = 10) {
    if (!(0, connection_1.isDbConnected)()) {
        return getTransactionHistory(limit);
    }
    const rows = await (0, services_1.getTransactionsByUser)(userId, limit);
    return rows.map((t) => ({
        id: t.id,
...
function getTransactionSummaryFromRecords(records) {
